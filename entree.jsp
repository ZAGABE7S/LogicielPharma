...
<br/>
 <center><h2 class="margin">Nouvelle entr&eacutee</h2></center>
		...
		<form:input type="hidden" path="id" id="id" />
                    ...
                    <div  class="form-group">
                        ...
                        <div class="col-sm-1"> 
                       	...
                       	<label for="quantite_entree" class="control-label col-sm-3" >Quantit&eacute: </label>
                        <div class="col-sm-2"> 
                            <input type= "number" class="forn-control" path="quantite_entree" name="quantite"/>
                        </div>
                    ...
                    <div class="form-group" >
                        ...
                        <label for="date_entree" class="control-label col-sm-3">Date entrée </label> 
                     <div class="col-sm-2">  
	...
	<br> Go back to <a href="<c:url value='/listeEntree' />">Liste des entrees</a>
...
<div class="container" >
  <form method="POST" modelAttribute="entree">
    ...
    <div class="form-group row">
      <label for="date_entree" class="col-sm-2 col-form-label">Date entrée</label>
      <div class="col-sm-10">
	...
	<center><br> Go back to <a href="<c:url value='/listeEntree' />">Liste des entrees</a></center>					
</body>
</html>
