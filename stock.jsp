...
<div class="container-fluid bg-2 text-center">
	...
	<!--<br> Go back to <a href="<c:url value='/Entree/allEntree' />">Liste des entrees</a>-->
				<div id="list_de_trucs">			<table class="table table-bordered">
							<caption>Stock disponible</caption>
								<thead>
									<tr>
									<th >Produit</th>
									<th > Catégorie</th>
								...
								<tbody>
			             <c:forEach var="affich" items="${listeproduit }">
			             	
			              <tr scope="row">
			              		<td>   <c:out value="${affich.nom_produit}"></c:out> </td>
			              		<td>   <c:out value="${affich.categorie}"></c:out> </td>
			              		<td>   <c:out value="${affich.posologie}"></c:out> </td>
